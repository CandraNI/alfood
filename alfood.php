                ...
                if($claims->success == true) 
                        {
                        ...
                        else 
                            {
                                echo "\e[91m [×] Gagal Claim Voucer !";
                                    ...
                                    // SANTAI11
                                        echo "\e[96m[!] Proses Reedem Voucher 20+10 : GOPAYTANGO1 \n";
                                        $data4 = '{"promo_code":"GOPAYTANGO1"}';
                                        ...
                                        if($claims1->success == true) 
                                                {
                                                ...
                                                } else 
                                                    {
                                                        echo "\e[91m [×] Gagal Claim Voucer !";
                                                            ...
                                                            // SANTAI08
                                                                echo "\e[96m[!] Proses Redeem Voucher 15+10 : COBAINGOJEK \n";
                                                                ...
                                                                if($claims2->success == true) 
                                                                        {
                                                                        ...
                                                                        } else 
                                                                            {
                                                                                echo "\e[91m [×] Gagal Claim Voucer !";
                                                                                    ...
                                                                                    // SANTAI08
                                                                                        echo "\e[96m[!] Proses Redeem Voucher 10+10 : AYOCOBAGOJEK \n";
                                                                                        $data6 = '{"promo_code":"AYOCOBAGOJEK"}';
